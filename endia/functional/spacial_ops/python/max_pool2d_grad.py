                ...
                for out_w in range(out_width):
                    ...
                    for kh in range(kernel_size):
                        for kw in range(kernel_size):
                            ...
                            if (0 <= current_in_h < in_height and
                                0 <= current_in_w < in_width):

                                current_val = input_tensor[b, c, current_in_h, current_in_w]
...
class TestMaxPool2dBackward(unittest.TestCase):
    ...
    def _test_max_pool2d_backward_case(self, input_shape, kernel_size, stride, padding, dilation):
    ...
    def test_kernel_larger_than_input(self):
        self._test_max_pool2d_backward_case(input_shape=(1, 1, 6, 6), kernel_size=5, stride=1, padding=0, dilation=1)
    ...
    def test_invalid_output_size_padding(self):
        self._test_max_pool2d_backward_case(input_shape=(1, 1, 3, 3), kernel_size=5, stride=1, padding=2, dilation=1)
