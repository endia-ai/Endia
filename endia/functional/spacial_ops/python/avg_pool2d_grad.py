...
def manual_avg_pool2d_backward(input_tensor, output_grad, kernel_size, stride, padding):
    """
    Manually computes the gradient of avg_pool2d.
        ...
        for c in range(in_channels):
            for out_h in range(out_height):
                for out_w in range(out_width):
                    ...
                    # Gradient for avg_pool2d is distributed equally to all elements in the kernel
                    grad_to_distribute = output_grad[b, c, out_h, out_w] / (kernel_size * kernel_size)
                    ...
                    for kh in range(kernel_size): # Iterate over kernel height indices
                        for kw in range(kernel_size): # Iterate over kernel width indices
                            ...
                            if (0 <= current_in_h < in_height) and (0 <= current_in_w < in_width):
                                input_gradient[b, c, current_in_h, current_in_w] += grad_to_distribute
    return input_gradient


class TestAvgPool2dBackward(unittest.TestCase):

    def _test_avg_pool2d_backward_case(self, input_shape, kernel_size, stride, padding):
        ...
        manual_gradient = manual_avg_pool2d_backward(
            input_tensor,
            output_grad,
            kernel_size,
            stride,
    ...
    def test_basic_case(self):
        self._test_avg_pool2d_backward_case(input_shape=(2, 3, 8, 8), kernel_size=2, stride=2, padding=0)

    def test_stride_1(self):
        self._test_avg_pool2d_backward_case(input_shape=(1, 1, 7, 7), kernel_size=3, stride=1, padding=0)

    def test_dilation_2(self):
        self._test_avg_pool2d_backward_case(input_shape=(1, 3, 10, 10), kernel_size=3, stride=1, padding=1)

    def test_kernel_larger_than_input(self):
        self._test_avg_pool2d_backward_case(input_shape=(1, 1, 6, 6), kernel_size=5, stride=1, padding=0)

    def test_padding(self):
        self._test_avg_pool2d_backward_case(input_shape=(4, 5, 16, 16), kernel_size=3, stride=2, padding=1)
    ...
    def test_different_input_sizes(self):
        ...
        for input_shape in test_cases:
            self._test_avg_pool2d_backward_case(
    ...
    def test_no_padding_dilation_stride_1(self):
        self._test_avg_pool2d_backward_case(input_shape=(2, 3, 7, 7), kernel_size=3, stride=1, padding=0)

    def test_batch_size_4(self):
        self._test_avg_pool2d_backward_case(input_shape=(4, 3, 8, 8), kernel_size=2, stride=2, padding=0)

    def test_channels_4(self):
        self._test_avg_pool2d_backward_case(input_shape=(2, 4, 8, 8), kernel_size=2, stride=2, padding=0)

    def test_small_input(self):
        self._test_avg_pool2d_backward_case(input_shape=(1, 1, 2, 2), kernel_size=2, stride=1, padding=0)

    def test_invalid_output_size_padding(self):
        self._test_avg_pool2d_backward_case(input_shape=(1, 1, 3, 3), kernel_size=5, stride=1, padding=2)
