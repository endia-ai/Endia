...
struct ACos(DifferentiableUnaryOp):
    ...
    fn fwd(arg0: Array) raises -> Array:
        """Computes the ArcPointercosine of the input array element-wise.

        Args:
            arg0: The input array.

        Returns:
            An array containing the ArcPointercosine of each element in the input array.
        ...
        """
        if arg0.is_complex():
            raise "FIX: Complex numbers are not supported for the ArcPointercosine function yet."
    ...
    fn jvp(primals: List[Array], tangents: List[Array]) raises -> Array:
        """Computes the Jacobian-vector product for the ArcPointercosine function.

        Implements forward-mode automatic differentiation for the ArcPointercosine function.
        ...
        Returns:
            The Jacobian-vector product for the ArcPointercosine function.

        #### Note:
        The Jacobian-vector product for ArcPointercosine is computed as -1 / sqrt(1 - x^2) * dx,
    ...
    fn vjp(primals: List[Array], grad: Array, out: Array) raises -> List[Array]:
        """Computes the vector-Jacobian product for the ArcPointercosine function.

        Implements reverse-mode automatic differentiation for the ArcPointercosine function.
        ...
        #### Note:
        The vector-Jacobian product for ArcPointercosine is computed as -1 / sqrt(1 - x^2) * grad,
    ...
    fn unary_simd_op(
        ...
        """
        Low-level function to compute the ArcPointercosine of a complex number represented as SIMD vectors.
        ...
        Returns:
            The real and imaginary parts of the ArcPointercosine of the complex number as a tuple.
        """
    ...
    fn __call__(inout curr: Array, args: List[Array]) raises:
        """Performs the forward pass for element-wise ArcPointercosine computation of an array.

        Computes the ArcPointercosine of each element in the input array and stores the result in the current array.
